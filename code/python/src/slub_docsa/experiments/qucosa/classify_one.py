...
if __name__ == "__main__":
    ...
    dataset_name = "qucosa_de_complete_but_only_abstracts_rvk"
    ...
    train_dataset, test_dataset = scikit_kfold_train_test_split(0.9, named_dataset.dataset, random_state=random_state)
