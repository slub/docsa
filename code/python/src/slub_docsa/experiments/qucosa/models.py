...
def default_qucosa_named_clustering_models_tuple_list(
    ...
    tfidf_vectorizer_10k = partial(get_cached_tfidf_stemming_vectorizer, max_features=10000)
    dbmdz_bert_vectorizer_sts_1 = partial(_get_cached_dbmdz_bert_vectorizer, subtext_samples=1)
