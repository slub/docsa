...
All paths (except `ROOT_DIR`) can be overwritten by specifying environment variables:
...
>>> paths.DATA_DIR = "/my/custom/data/dir"
"""
...
"""The root directory of the python package (for development purposes only)."""

DATA_DIR = os.environ.get("SLUB_DOCSA_DATA_DIR", os.path.join(ROOT_DIR, "data/"))
...
RESOURCES_DIR = os.environ.get("SLUB_DOCSA_RESOURCES_DIR", os.path.join(DATA_DIR, "resources/"))
...
CACHE_DIR = os.environ.get("SLUB_DOCSA_CACHE_DIR", os.path.join(DATA_DIR, "runtime/cache/"))
...
FIGURES_DIR = os.environ.get("SLUB_DOCSA_FIGURES_DIR", os.path.join(DATA_DIR, "runtime/figures/"))
...
ANNIF_DIR = os.environ.get("SLUB_DOCSA_ANNIF_DIR", os.path.join(DATA_DIR, "runtime/container/annif/data"))
